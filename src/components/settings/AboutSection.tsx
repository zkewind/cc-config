    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/zkewind/cc-config/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/zkewind/cc-config/releases/tag/${displayVersion}`,
      );
    } catch (error) {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <img src={appIcon} alt="CCConfig" className="h-5 w-5" />
