...
export const handlers = [
  ...
  http.post(`${TAURI_ENDPOINT}/get_skill_backups`, () => success([])),
  http.post(`${TAURI_ENDPOINT}/scan_unmanaged_skills`, () => success([])),
  http.post(`${TAURI_ENDPOINT}/check_skill_updates`, () => success([])),
  ...
  http.post(`${TAURI_ENDPOINT}/get_config_dir`, async () =>
    success("/default/claude"),
  ),
