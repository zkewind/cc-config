...
const emitTauriEvent = (event: string, payload: unknown) => {
  tauriEventListeners.get(event)?.forEach((handler) => handler({ payload }));
};
...
vi.mock("@tauri-apps/api/event", () => ({
  listen: async (
    ...
    if (!tauriEventListeners.has(event)) {
      tauriEventListeners.set(event, new Set());
    }
...
describe("App integration with MSW", () => {
  ...
  it("covers basic Claude provider flows via real hooks", async () => {
