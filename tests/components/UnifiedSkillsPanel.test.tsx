...
describe("UnifiedSkillsPanel", () => {
  ...
  it("renders installed skill cards and toggles app enablement", async () => {
    installedSkills = [
      {
        id: "skill-1",
    ...
    const appButtons = screen.getAllByRole("button").filter((button) =>
      button.className.includes("w-7"),
    );
    await act(async () => {
      appButtons[0].click();
    });
