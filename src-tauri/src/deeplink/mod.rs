//! Deep link import functionality for CCConfig
//!
//! This module implements the ccconfig:// protocol for importing configurations
//! via deep links. Supports importing:
//! - Provider configurations (Claude)
...
///
/// Represents a parsed ccconfig:// URL ready for processing.
...
pub struct DeepLinkImportRequest {
    ...
    // ============ Common fields ============
    /// Target application (claude) - for provider, prompt, skill
