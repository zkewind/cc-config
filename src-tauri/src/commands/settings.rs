...
) -> Result<crate::proxy_types::RectifierConfig, String> {
...
pub async fn get_optimizer_config(
    state: tauri::State<'_, crate::AppState>,
) -> Result<crate::proxy_types::OptimizerConfig, String> {
...
pub async fn get_copilot_optimizer_config(
    state: tauri::State<'_, crate::AppState>,
) -> Result<crate::proxy_types::CopilotOptimizerConfig, String> {
    state
        .db
...
pub async fn get_log_config(
    state: tauri::State<'_, crate::AppState>,
) -> Result<crate::proxy_types::LogConfig, String> {
...
pub async fn set_log_config(
    state: tauri::State<'_, crate::AppState>,
    config: crate::proxy_types::LogConfig,
) -> Result<bool, String> {
    state
        .db
...
/// 获取托管的项目路径列表
#[tauri::command]
pub async fn get_managed_project_paths(
    state: tauri::State<'_, crate::AppState>,
...
/// 添加一个托管项目路径
#[tauri::command]
pub async fn add_managed_project_path(
    state: tauri::State<'_, crate::AppState>,
    path: String,
) -> Result<bool, String> {
    ...
    state
        .db
        .add_managed_project_path(&path)
        .map_err(|e| e.to_string())
}

/// 移除一个托管项目路径
#[tauri::command]
pub async fn remove_managed_project_path(
    state: tauri::State<'_, crate::AppState>,
    path: String,
) -> Result<bool, String> {
    state
